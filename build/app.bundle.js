...
var _Order = __webpack_require__(337);

var _Order2 = _interopRequireDefault(_Order);

var _base = __webpack_require__(93);

var _list3 = __webpack_require__(338);

var _orderView = __webpack_require__(339);
...
var listItem = function listItem() {
    state.listStruc = new _list2.default();
    state.listStruc.loadItem();

    //--- Concern with populating the list or say the product showcase of the company
    (0, _list3.pagination)(state.listStruc.list);
};
/// Initializes the Orders model
state.order = new _Order2.default();

//======Updates the counter inside the models
var updateCounter = function updateCounter(id, type) {
    state.order.updateCounter(id, type);
};

// Event Listener for the adding to the order menu, i.e the right hand side of the setup
_base.elements.list.addEventListener('click', function (e) {
    //--- Basically algorithm to get the dataset stored in the html structure
    var orderGoto = e.target.closest('.cart-card');
    if (orderGoto) {
        var selectedItem = state.listStruc.list.find(function (el) {
            return el.id === +orderGoto.dataset.goto;
        });
        var image_url = selectedItem.image_url,
        ...
        var orderEachItem = state.order.addItem(id, price, title, image_url);

        //--- Implement the Order view
        if (orderEachItem) {
            (0, _orderView.orderView)(orderEachItem);
        }
    }
});
...
_base.elements.order.addEventListener('click', function (e) {
    ...
    if (e.target.closest('.counter-minus')) {
        ...
        state.order.order.find(function (el) {
            if (el.id === selectedForUpdate) (0, _orderView.updateViewCounter)(el, e.target.nextElementSibling);
        });
    }
    ...
    if (e.target.closest('.counter-plus')) {
        ...
        state.order.order.find(function (el) {
            if (el.id === selectedForUpdate) (0, _orderView.updateViewCounter)(el, e.target.previousElementSibling);
        });
    }
});
/////======== Pagonation of the page  ====
_base.elements.pagesView.addEventListener('click', function (e) {
    var goto = e.target.closest('.pagination');

    if (goto) {
        var gotoNum = goto.dataset.goto;
        (0, _list3.clearView)();

        //=====Minor changes with implementing the spinner before rendering the next page
        (0, _list3.spinner)();
        setTimeout(function () {
            (0, _list3.clearSpinner)();
            (0, _list3.pagination)(state.listStruc.list, gotoNum);
        }, 1000);
    }
});
...
var _data = __webpack_require__(336);
...
var List = function () {
    ...
    _createClass(List, [{
        ...
        value: function loadItem() {
            ...
            _data.datas.forEach(function (data) {
                return _this.list.push(data);
            });
        }
    }]);
...
var Order = function () {
    ...
    _createClass(Order, [{
        key: 'addItem',
        value: function addItem(id, price, title, image) {
            ...
            };if (this.order.find(function (el) {
                return el.id === orderItem.id;
            })) {
                return;
            }
        ...
        value: function deleteItem(id) {
            var index = this.order.findIndex(function (el) {
                return el.id === id;
            });
        ...
        key: 'updateCounter',
        value: function updateCounter(id, type) {
            var _this = this;

            var item = this.order.find(function (el) {
                if (el.id === id) {
                    if (type === 'inc') {
                        el.count += 1;
                    ...
                    _this.updateAmount(id);
                }
            });
        }
    }, {
        key: 'updateAmount',
        value: function updateAmount(id) {
            var item = this.order.find(function (el) {
                if (el.id === id) {
                    var priceOnly = +el.price.replace('$', '');
...
exports.clearSpinner = exports.spinner = exports.pagination = exports.clearView = undefined;
...
var clearView = exports.clearView = function clearView() {
    ...
    _base.elements.pagesView.innerHTML = '';
};
...
var renderItems = function renderItems(item) {
    ...
    _base.elements.list.insertAdjacentHTML('beforeend', html);
};
...
var renderButtons = function renderButtons(totalPages, page) {
    var button = void 0;
...
var pagination = exports.pagination = function pagination(contents) {
...
var spinner = exports.spinner = function spinner() {
    var html = '<i id="styleSpinner" class="bi bi-arrow-clockwise"></i>';
    _base.elements.list.innerHTML = html;
};
...
exports.updateViewCounter = exports.deleteOrderView = exports.orderView = undefined;

var _base = __webpack_require__(93);

var orderView = exports.orderView = function orderView(orderItem) {
    ...
    _base.elements.order.insertAdjacentHTML('beforeend', html);
};
var deleteOrderView = exports.deleteOrderView = function deleteOrderView(item) {
...
var updateViewCounter = exports.updateViewCounter = function updateViewCounter(el, target) {
...
var deleteTransition = function deleteTransition(item) {
