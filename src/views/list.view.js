...
const createButton = (page, type) => `
    <button class=" pagination btn-inline results__btn--${type}" data-goto=${
...
const renderButtons = (totalPages, page) => {
    ...
    if (page === 1 && totalPages > 1) {
        ...
        //both buttons
        button = `${createButton(page, 'next')} ${createButton(
      page,
      'prev'
    )} `;
    }
...
export const spinner = () => {
    let html = `<i id="styleSpinner" class="bi bi-arrow-clockwise"></i>`;
